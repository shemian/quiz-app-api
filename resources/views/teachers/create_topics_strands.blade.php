                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('store_topics_and_strands') }}">
                            ...
                            <div class="row mb-3">
                                <label for="topic_strand" class="col-md-4 col-form-label text-md-end">{{ __('Topic/Strand') }}</label>

                                <div class="col-md-6">
                                    <input id="topic_strand" type="text" class="form-control @error('topic_strand') is-invalid @enderror" name="topic_strand"  required >
