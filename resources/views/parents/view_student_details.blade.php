    ...
    <div class="row">
        <div class="col-xl-4 col-lg-5">
            <div class="card text-center">
                <div class="card-body">
                    <img>
                    <h4 class="mb-0 mt-2">{{ $student->user->name }}</h4>
                    <p class="text-muted mb-2 font-13"><strong>Account Status :</strong> <span class="ms-2">
                    ...
                    <div class="text-start mt-3">
                        ...
                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ms-2">
                                                   {{ $student->user->name }}</span></p>

                        <p class="text-muted mb-2 font-13"><strong>CentyPlus ID :</strong><span class="ms-2">
                                                    {{ $student->user->centy_plus_id  }}</span></p>
                        <p class="text-muted mb-2 font-13"><strong>School Name:</strong> <span class="ms-2 ">{{ $student->school_name }}</span></p>

                        <p class="text-muted mb-2 font-13"><strong>Education Level :</strong> <span class="ms-2 ">{{ $student->EducationLevel->name }}</span></p>

                        <p class="text-muted mb-1 font-13"><strong>Centii Balance :</strong> <span class="ms-2">{{ $student->debit }}</span></p>
                        <p class="text-muted mb-1 font-13"><strong>Escrow Balance :</strong> <span class="ms-2">{{ $student->centy_balance }}</span></p>
                    </div>
